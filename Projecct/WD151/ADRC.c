...
/*  r     h      N                  beta_01   beta_02    beta_03     b0     beta_0  beta_1     beta_2     N1     C    alpha1  alpha2  zeta       b*/
 {3000000 ,0.004 , 5,               300,      7000,      1000,      20,    0.95,   1.5,      0.001,      200,    5,    0.7,   1.0,    0.01,    0.1},
 {1000000 ,0.004 , 6,               300,      7000,      1000,      20,    0.85,   1.5,      0.0003,      200,    5,    0.8,   1.2,    0.03,    0.1},
 {1000000 ,0.01 , 5,               300,      4000,      10000,     100,   0.2,    1.2,      0.0010,      5,      5,    0.8,   1.5,    0.03,    0.05}
};
...
{ 
	//期望和反馈都通过TD过渡
		Fhan_ADRC(fhan_Input1,expect_ADRC);
		Fhan_ADRC(fhan_Input2,feedback_ADRC);

	fhan_Input1->u0+=PID_Increase(&Ang_gyro_PID, Ang_gyro, -fhan_Input2->x1, 0);
